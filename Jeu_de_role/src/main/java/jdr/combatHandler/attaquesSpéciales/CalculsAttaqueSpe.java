...
public class CalculsAttaqueSpe extends CalculsAttaque {
    ...
    public void getPlayerInfoDD() {
        ...
        int random = Randomiser.randomizer(5, 25);
        int randomfail = Randomiser.randomizer(-5, random);
        int chance;
        chance = Randomiser.randomizer(1, 10);
        System.out.println("+===============================================================================================================+");
        System.out.println("|Déclenchement: [Dés du Diable] ⚀⚅(Bonus d'attaque= (5-25) (70% de succès/ Peut être fatal en cas d'échec))");
    ...
    public void getPlayerInfoRage() {
        ...
        if (random1 < 20) {
            ...
            System.out.println("| La rage qui vous habite est telle que le monstre devant vous tente de prendre la fuite, vous le rattrapez et le tuez (probablement) d'un seul coup");
            System.out.println("| (◣_◢) Force du héros = " + random1);
        }
